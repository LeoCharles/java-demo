 ...
 *
 *
 * 操作路径不要写死了，要用 File.separator
 * windows: E:\\Java\\java-demo
 * linux:   E:/Java/java-demo
 * "E:" + "File.separator + "Java" + File.separator + "java-demo"
 *
 * 构造方法：
 ...
 * public String getPath() ：将此File转换为路径名字符串。toString 方法调用的是 getPath
 * public String getName() ：返回由此File表示的文件或目录的名称。
 * public long length() ：返回由此File表示的文件的字节数。
 *
