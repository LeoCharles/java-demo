 ...
 * 常用的函数式接口：
 *
 * java.util.function.Supplier<T> 接口包含一个无参方法：T get()。用来获取一个泛型参数指定类型的对象数据。生产型接口。
 *
...
//        };
    ...
    // 获取 int 数组中的最大值，参数传入一个 Supplier<Integer> 接口
    ...
    public static void testConsumer(String str, Consumer<String> con1, Consumer<String> con2) {
    ...
    public static boolean testPredicate(String str, Predicate<String> pred1, Predicate<String> pred2) {
    ...
    // 使用 Function 转换类型
    public static String change(String str, Function<String, Integer> func1, Function<Integer, String> func2) {
